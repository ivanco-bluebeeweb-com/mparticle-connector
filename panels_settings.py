"""Settings panel for mParticle Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__mparticle_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=mparticle_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_mparticle"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("mParticle Settings & Accounts", level=2),
